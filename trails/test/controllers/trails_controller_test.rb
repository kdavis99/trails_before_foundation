...
class TrailsControllerTest < ActionController::TestCase
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post :create, trail: { EndLat: @trail.EndLat, EndLng: @trail.EndLng, Name: @trail.Name, StartLat: @trail.StartLat, StartLng: @trail.StartLng }
    end
  ...
  test "should update trail" do
    patch :update, id: @trail, trail: { EndLat: @trail.EndLat, EndLng: @trail.EndLng, Name: @trail.Name, StartLat: @trail.StartLat, StartLng: @trail.StartLng }
    assert_redirected_to trail_path(assigns(:trail))
  end
